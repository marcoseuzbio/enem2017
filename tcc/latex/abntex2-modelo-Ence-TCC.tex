...
titulo{Analise nas variáveis socioeconômicas o ENEM em 2017: que influenciam na aprovação dos candidatos inscritos} % O ALUNO DEVE EDITAR AQUI
...
\postextual
%
\bibliography{pacoteence-modelos-references}
%
% ----------------------------------------------------------
% Glossário
% ----------------------------------------------------------
